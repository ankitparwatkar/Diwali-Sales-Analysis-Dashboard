...
<div style="background: rgba(255,255,255,0.1); padding: 20px; border-radius: 15px; margin-bottom: 20px; border: 1px solid #FFD700; box-shadow: 0 0 20px rgba(255, 215, 0, 0.3); position: relative; overflow: hidden;">
    ...
    <p style="color: white; text-align: center; font-style: italic; font-size: 1.1rem; text-shadow: 0 0 5px rgba(0,0,0,0.5); position: relative; z-index: 2;">Data Analyst | Business Intelligence Specialist</p>
</div>
""", unsafe_allow_html=True)
...
with geo2:
    ...
    try:
        ...
        st.warning("Map visualization not available in this environment")
